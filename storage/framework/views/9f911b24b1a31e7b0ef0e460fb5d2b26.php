            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('employees.index')); ?>"
                            class="nav-link active">list employee</a></li>
        ...
        <div class="row mb-0">
            ...
            <div class="col-lg-3 col-xl-2">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary">Buat Data Barang</a>
                </div>
            </div>
        </div>
        <hr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <form action="<?php echo e(route('employees.deleteFile', ['employeeId' => $employee->id])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('delete'); ?>
...
<?php /**PATH E:\SI pemrograman framework\shaquille_factory\resources\views/employee/actions.blade.php ENDPATH**/ ?>